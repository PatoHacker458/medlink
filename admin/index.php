...
<div class="container mt-4">
    ...
    <p class="lead">Bienvenido/a, <?php echo htmlspecialchars($_SESSION['correo'] ?? 'Usuario'); ?>
        <?php if ($web->checar_permiso('Administrador')): ?>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        ...
                        <a href="medico.php" class="stretched-link"></a>
                    </div>
                </div>
            </div>
    ...
    <div class="list-group mb-4 shadow-sm">
        ...
        <?php if ($web->checar_permiso('Gestionar_citas')): ?>
