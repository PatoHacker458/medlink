    ...
    <form method="POST" action="cita.php?accion=<?php echo (isset($info['id_cita'])) ? 'modificar&id='.$info['id_cita'] : 'crear'; ?>">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select class="form-select" id="id_medico" name="datos[id_medico]" required>
                     <option value="">Selecciona un médico...</option>
                    <?php foreach ($medicos as $medico): ?>
                        <option value="<?php echo $medico['id_medico']; ?>" <?php echo (isset($info['id_medico']) && $info['id_medico'] == $medico['id_medico']) ? 'selected' : ''; ?>>
            ...
            <div class="col-md-6">
                 ...
                 <input type="number" step="0.01" class="form-control" id="precio" name="datos[precio]" value="<?php echo htmlspecialchars($info['precio'] ?? ''); ?>" placeholder="Ej: 500.00">
            </div>
